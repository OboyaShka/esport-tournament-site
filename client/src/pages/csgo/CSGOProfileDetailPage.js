...
export const CSGOProfileDetailPage = () => {
                    ...
                    <div className="statistics-card-area">
                        <div className="statistics-card">
                            <div className="card-container">
                                ...
                                <img src={LineIcon}/>
                                <var className="stat-var-block">{profile.stat_csgo_tournaments_played}</var>
                            </div>
                        </div>
                    ...
                    <div className="statistics-card-area">
                        <div className="statistics-card">
                            <div className="card-container">
                                ...
                                <img src={LineIcon}/>
                                <var className="stat-var-block">{profile.stat_csgo_tournaments_wins}</var>
                            </div>
                        </div>
                    ...
                    <div className="statistics-card-area">
                        <div className="statistics-card">
                            <div className="card-container">
                                ...
                                <img src={LineIcon}/>
                                <var className="stat-font-size">{profile.stat_csgo_tournaments_rating}</var>
                            </div>
                        </div>
                    ...
                    <div className="statistics-card-area">
                        <div className="statistics-card">
                            <div className="card-container">
                                ...
                                <img src={LineIcon}/>
                                <var className="stat-font-size">{profile.stat_csgo_total_BC}</var>
                            </div>
                        </div>

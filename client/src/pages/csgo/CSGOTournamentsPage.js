...
import {CSGOTournamentsCards} from "./CSGOTournamentsCards"

export const CSGOTournamentsPage = () => {
    ...
    return (
        <div className="tournaments-container">
            <div className="tournaments-title">Турниры по CS:GO</div>
            ...
            <CSGOTournamentsCards type={type} search={search}/>

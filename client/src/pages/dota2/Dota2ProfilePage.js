...
export const Dota2ProfilePage = () => {
    ...
    const [form, setForm] = useState({
        image: null, summonersName: null, steamID: null
    })
    ...
    return (
        <div className="my-profile-container">
            <h2 className="my-profile-title">Мой аккаунт Dota 2</h2>
                ...
                <div className="statistics-card-area">
                    <div className="statistics-card">
                        <div className="card-container">
                            ...
                            <img src={LineIcon}/>
                            <var className="stat-var-block">{user.stat_dota2_tournaments_played}</var>
                        </div>
                    </div>
                ...
                <div className="statistics-card-area">
                    <div className="statistics-card">
                        <div className="card-container">
                            ...
                            <img src={LineIcon}/>
                            <var className="stat-var-block">{user.stat_dota2_tournaments_wins}</var>
                        </div>
                    </div>
                ...
                <div className="statistics-card-area">
                    <div className="statistics-card">
                        <div className="card-container">
                            ...
                            <img src={LineIcon}/>
                            <var className="stat-font-size">{user.stat_dota2_total_RC}</var>
                        </div>
                    </div>
                ...
                <div className="statistics-card-area">
                    <div className="statistics-card">
                        <div className="card-container">
                            ...
                            <img src={LineIcon}/>
                            <var className="stat-var-block">{user.stat_dota2_tournaments_prizer}</var>
                        </div>
                    </div>
                    <p>Призовых мест</p>
                </div>
                ...
                <div className="statistics-card-area">
                    <div className="statistics-card">
                        <div className="card-container">
                            ...
                            <img src={LineIcon}/>
                            <var className="stat-font-size">{user.stat_dota2_tournaments_rating}</var>
                        </div>
                    </div>
                ...
                <div className="statistics-card-area">
                    <div className="statistics-card">
                        <div className="card-container">
                            ...
                            <img src={LineIcon}/>
                            <var className="stat-font-size">{user.stat_dota2_total_BC}</var>
                        </div>
                    </div>
            ...
            {!loading && mytournaments && <div className="my-profile-games">
                {!mytournaments.length ?
                    (<p className="bracket-match-text">Вы не заявлены на турниры по Dota 2</p>) :

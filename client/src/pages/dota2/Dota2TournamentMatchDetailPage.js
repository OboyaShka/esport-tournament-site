...
export const Dota2TournamentMatchDetailPage = () => {
        ...
        <div>
            ...
            <div className="detail-match">
                ...
                <div className="players-match">
                    <Link to={match && match.participants[0] != null ? `/dota2/profile/${match.participants[0]._id}` : ""}
                    ...
                    <Link to={match && match.participants[1] != null ? `/dota2/profile/${match.participants[1]._id}` : ""}

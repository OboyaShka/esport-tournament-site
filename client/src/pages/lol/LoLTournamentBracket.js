...
export const LoLTournamentBracket = () => {
    ...
    return (
        <div>
            ...
            {tournament && matches && matches != [] && tournament != [] && matches1 && matches2 && matches4 && matches8 &&
            <div className="bracket-content">
                <div className="bracket-main-8">
                    ...
                    <div className="bracket-final-8">
                        ...
                        <Link to={`/lol/tournaments/${tournamentId}/matches/${matches1[0]._id}`} style={{ textDecoration:"none"}} className="bracket-match-final">
                            <div className={matches1[0].winner && matches1[0].participants[0]._id === matches1[0].winner? "bracket-match-final-l-w":"bracket-match-final-l"}>
                                <div className="bracket-img-l">
                                    <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                </div>
                                <div className={matches1[0].winner && matches1[0].participants[0]._id === matches1[0].winner? "bracket-match-text-final-w":"bracket-match-text-final"}>{matches1[0].participants[0].nickname}</div>
                            </div>
                            <div className={matches.winner && matches1[0].participants[1]._id === matches1[0].winner? "bracket-match-final-r-w":"bracket-match-final-r"}>
                                <div className={matches1[0].winner && matches1[0].participants[1]._id === matches1[0].winner? "bracket-match-text-final-w":"bracket-match-text-final"}>{matches1[0].participants[1].nickname}</div>
                    ...
                    <div className="bracket-main-content-4">
                        ...
                        <div className="bracket-matches-chain">
                            ...
                            <div className="match-set-center">
                                <Link Link to={`/lol/tournaments/${tournamentId}/matches/${matches4[0]._id}`} style={{ textDecoration:"none"}}   className={matches4[0].winner && matches4[0].participants[0]._id === matches4[0].winner? "bracket-match-t-w":"bracket-match-t"}>
                                    <div className="bracket-img-l">
                                        <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                    </div>
                                    <div  className={matches4[0].winner && matches4[0].participants[0]._id === matches4[0].winner? "bracket-match-text-w":"bracket-match-text"}>{matches4[0].participants[0].nickname}</div>
                                </Link>
                            </div>
                            <div className="bracket-match-border-block">
                                <div className="match-set-center">
                                    <Link Link to={`/lol/tournaments/${tournamentId}/matches/${matches4[0]._id}`} style={{ textDecoration:"none"}}   className={matches4[0].winner && matches4[0].participants[1]._id === matches4[0].winner? "bracket-match-b-w":"bracket-match-b"}>
                                        <div className="bracket-img-l">
                                            <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                        </div>
                                        <div  className={matches4[0].winner && matches4[0].participants[1]._id === matches4[0].winner? "bracket-match-text-w":"bracket-match-text"}>{matches4[0].participants[1].nickname}</div>
                                    </Link>
                                </div>

                                <div className="match-set-center">
                                    <Link Link to={`/lol/tournaments/${tournamentId}/matches/${matches4[1]._id}`} style={{ textDecoration:"none"}}   className={matches4[1].winner && matches4[1].participants[0]._id === matches4[1].winner? "bracket-match-t-w":"bracket-match-t"}>
                                        <div className="bracket-img-l">
                                            <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                        </div>
                                        <div  className={matches4[1].winner && matches4[1].participants[0]._id === matches4[1].winner? "bracket-match-text-w":"bracket-match-text"}>{matches4[1].participants[0].nickname}</div>
                                    </Link>
                                </div>
                            </div>
                            <div className="match-set-center">
                                <Link Link to={`/lol/tournaments/${tournamentId}/matches/${matches4[1]._id}`} style={{ textDecoration:"none"}}  className={matches4[1].winner && matches4[1].participants[1]._id === matches4[1].winner? "bracket-match-b-w":"bracket-match-b"}>
                                    <div className="bracket-img-l">
                                        <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                    </div>
                                    <div  className={matches4[1].winner && matches4[1].participants[1]._id === matches4[1].winner? "bracket-match-text-w":"bracket-match-text"}>{matches4[1].participants[1].nickname}</div>
                                </Link>
                            </div>
                        </div>}
                    ...
                    <div className="bracket-main-content-2">
                        ...
                        <div className="bracket-match-1-2">
                            <div className="bracket-match-1-2-border">
                                <div className="match-set-center">
                                    <Link to={`/lol/tournaments/${tournamentId}/matches/${matches2[0]._id}`} style={{ textDecoration:"none"}} className={matches2[0].winner && matches2[0].participants[0]._id === matches2[0].winner? "bracket-match-t-w":"bracket-match-t"}>
                                        <div className="bracket-img-l">
                                            <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                        </div>
                                        <div  className={matches2[0].winner && matches2[0].participants[0]._id === matches2[0].winner? "bracket-match-text-w":"bracket-match-text"}>{matches2[0].participants[0].nickname}</div>
                                    </Link>
                                </div>
                            </div>
                            <div className="match-set-center">
                                <Link to={`/lol/tournaments/${tournamentId}/matches/${matches2[0]._id}`} style={{ textDecoration:"none"}} className={matches2[0].winner && matches2[0].participants[1]._id === matches2[0].winner? "bracket-match-b-w":"bracket-match-b"}>
                                    <div className="bracket-img-l">
                                        <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                    </div>
                                    <div  className={matches2[0].winner && matches2[0].participants[1]._id === matches2[0].winner? "bracket-match-text-w":"bracket-match-text"}>{matches2[0].participants[1].nickname}</div>
                                </Link>
                            </div>
                        </div>}
                    </div>
                    ...
                    <div className="bracket-main-content-2">
                        ...
                        <div className="bracket-match-1-2">
                            <div className="bracket-match-1-2-border-r">
                                <div className="match-set-center">
                                    <Link to={`/lol/tournaments/${tournamentId}/matches/${matches2[1]._id}`} style={{ textDecoration:"none"}}  className={matches2[1].winner && matches2[1].participants[0]._id === matches2[1].winner? "bracket-match-t-w":"bracket-match-t"}>
                                        <div className="bracket-img-l">
                                            <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                        </div>
                                        <div  className={matches2[1].winner && matches2[1].participants[0]._id === matches2[1].winner? "bracket-match-text-w":"bracket-match-text"}>{matches2[1].participants[0].nickname}</div>
                                    </Link>
                                </div>
                            </div>
                            <div className="match-set-center">
                                <Link to={`/lol/tournaments/${tournamentId}/matches/${matches2[1]._id}`} style={{ textDecoration:"none"}}className={matches2[1].winner && matches2[1].participants[1]._id === matches2[1].winner? "bracket-match-b-w":"bracket-match-b"}>
                                    <div className="bracket-img-l">
                                        <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                    </div>
                                    <div  className={matches2[1].winner && matches2[1].participants[1]._id === matches2[1].winner? "bracket-match-text-w":"bracket-match-text"}>{matches2[1].participants[1].nickname}</div>
                                </Link>
                            </div>
                        </div>}
                    </div>
                    ...
                    <div className="bracket-main-content-4">
                        ...
                        <div className="bracket-matches-chain">
                            <div className="match-set-center">
                                <Link Link to={`/lol/tournaments/${tournamentId}/matches/${matches4[2]._id}`} style={{ textDecoration:"none"}}   className={matches4[2].winner && matches4[2].participants[0]._id === matches4[2].winner? "bracket-match-t-w":"bracket-match-t"}>
                                    <div className="bracket-img-l">
                                        <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                    </div>
                                    <div  className={matches4[2].winner && matches4[2].participants[0]._id === matches4[2].winner? "bracket-match-text-w":"bracket-match-text"}>{matches4[2].participants[0].nickname}</div>
                                </Link>
                            </div>
                            <div className="bracket-match-border-block-r">
                                <div className="match-set-center">
                                    <Link Link to={`/lol/tournaments/${tournamentId}/matches/${matches4[2]._id}`} style={{ textDecoration:"none"}}   className={matches4[2].winner && matches4[2].participants[1]._id === matches4[2].winner? "bracket-match-b-w":"bracket-match-b"}>
                                        <div className="bracket-img-l">
                                            <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                        </div>
                                        <div  className={matches4[2].winner && matches4[2].participants[1]._id === matches4[2].winner? "bracket-match-text-w":"bracket-match-text"}>{matches4[2].participants[1].nickname}</div>
                                    </Link>
                                </div>

                                <div className="match-set-center">
                                    <Link Link to={`/lol/tournaments/${tournamentId}/matches/${matches4[3]._id}`} style={{ textDecoration:"none"}}  className={matches4[3].winner && matches4[3].participants[0]._id === matches4[3].winner? "bracket-match-t-w":"bracket-match-t"}>
                                        <div className="bracket-img-l">
                                            <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                        </div>
                                        <div  className={matches4[3].winner && matches4[3].participants[0]._id === matches4[3].winner? "bracket-match-text-w":"bracket-match-text"}>{matches4[3].participants[0].nickname}</div>
                                    </Link>
                                </div>
                            </div>
                            <div className="match-set-center">
                                <Link Link to={`/lol/tournaments/${tournamentId}/matches/${matches4[3]._id}`} style={{ textDecoration:"none"}}  className={matches4[3].winner && matches4[3].participants[1]._id === matches4[3].winner? "bracket-match-b-w":"bracket-match-b"}>
                                    <div className="bracket-img-l">
                                        <img style={{maxWidth: "80%", borderRadius: "50%"}} src={auth.userAvatar}/>
                                    </div>
                                    <div  className={matches4[3].winner && matches4[3].participants[1]._id === matches4[3].winner? "bracket-match-text-w":"bracket-match-text"}>{matches4[3].participants[1].nickname}</div>
                                </Link>
                            </div>
                        </div>}

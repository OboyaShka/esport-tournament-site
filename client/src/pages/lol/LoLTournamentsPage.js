...
import {LoLTournamentsCards} from "./LoLTournamentsCards"
...
export const LoLTournamentsPage = () => {
    ...
    return (
        <div className="tournaments-container">
            <div className="tournaments-title">Турниры по League of Legends</div>
            ...
            <LoLTournamentsCards type={type} search={search}/>
